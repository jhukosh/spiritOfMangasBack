...
const wishListManga = require('./wishListManga')
...
module.exports = { users, mangas, packs, publics, series, types, genres, states, packsMangas, packsOrders, commandsMangas, genresMangas, wishListManga };
